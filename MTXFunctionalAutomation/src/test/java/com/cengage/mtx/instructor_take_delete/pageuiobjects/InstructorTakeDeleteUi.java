...
public class InstructorTakeDeleteUi extends BasePage {
	...
	/**
	 * Gets the list_ active score.
	 *
	 * @return the list_ active score
	 */
	public List<WebElement> getList_ActiveScore() {
		return getWhenVisibleList(
				By.xpath("//*[@id='student_summary']//a[@class='activity-score' and contains(text(),'%')]"),
				80);
	}
	...
	public WebElement getTxt_getDeleteTakeHeading() {
		return getWhenVisible(
				By.xpath("//*[contains(@class,'sub_list_title')]"), 30);
	}
	...
	public WebElement getTxt_Lastelement(int count) {
		return getWhenVisible(
				By.xpath("//*[@id='student_summary']/tr[" + count + "]"), 30);
	}
