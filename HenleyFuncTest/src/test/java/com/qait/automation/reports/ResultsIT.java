package com.qait.automation.reports;
...
public class ResultsIT {
	...
	void setupMailConfig() {
		YamlReader.setYamlFilePath("testData/integration_testData_ACS.yml");
		System.out.println("");
	}
	...
	public String setBodyText() throws IOException {
		...
		mailtext = mailtext + "<br><b><font color = green>Test Browser: </font></b>" + YamlReader.getYamlValue("browser");
		mailtext = mailtext + "<br><b><font color = green>Test Environment: </font></b>" + YamlReader.getYamlValue("appurl");
